                    ...
                    if (response.getString("ok").contains("1")) {
                        ...
                        if(cr.getCount() > 0){
                            while(cr.moveToNext()){
                                ...
                                //TODO Cambiar IntentService por Service para arreglar la notificacion https://stackoverflow.com/questions/21964375/waiting-for-asynchronous-callback-in-androids-intentservice
